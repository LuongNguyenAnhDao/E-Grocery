    ...
    <v-row justify="center" class="space px-16">
      ...
      >
        <v-card class="mx-auto rounded-xl" max-width="300" color="" flat outlined>
          ...
          <v-card-title class="text-grey text-grey-darken-1 caption mt-n6">{{
            product.subtitle
          }}</v-card-title>
          ...
          <v-card-actions class="mx-2 mt-n4">
            <v-btn outlined class="mt-n2 add">
              <v-icon color="green" @click="decrement"> mdi:mdi-minus </v-icon>
            </v-btn>
  
            <strong class="mx-2" v-text="bpm"></strong>
            <v-btn outlined class="mt-n2 add">
              <v-icon color="green" @click="increment"> mdi:mdi-plus </v-icon>
            </v-btn>
            <v-spacer></v-spacer>
            <v-btn class="mx-2 mt-n3" fab dark small color="green">
              <v-icon dark> mdi:mdi-shopping </v-icon>
            </v-btn>
          </v-card-actions>
        </v-card>
      </v-col>
